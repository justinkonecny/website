...
export class FeaturedProject extends Component {
    ...
    render() {
        return (
            <div
                className={
                    this.props.isMobile ? 'project project-mobile' : 'project'
                }
            >
                <div
                    className={
                        this.props.isMobile
                            ? 'project-descript project-descript-mobile'
                            : 'project-descript'
                    }
                >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <defs>
                                        <clipPath id="clip0">
                                            <path
                                                d="M0.00195312 0.5H20.002V20.5H0.00195312V0.5Z"
                                                fill="white"
                                            />
                                        </clipPath>
                                    </defs>
                ...
                <div
                    className={
                        this.props.isMobile
                            ? 'right-half right-half-mobile'
                            : 'right-half'
                    }
                >
                    {this.props.imageSrc.map((s) => (
                        <div
                            className={
                                this.props.isMobile
